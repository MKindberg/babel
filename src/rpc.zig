...
pub const MethodType = union(enum) {
    ...
    @"textDocument/hover": types.Request.Hover,
    @"textDocument/codeAction": types.Request.CodeAction,
    @"textDocument/declaration": types.Request.Declaration,
    @"textDocument/definition": types.Request.Definition,
    @"textDocument/formatting": types.Request.Formatting,
    @"textDocument/typeDefinition": types.Request.TypeDefinition,
    @"textDocument/implementation": types.Request.Implementation,
    @"textDocument/references": types.Request.References,
